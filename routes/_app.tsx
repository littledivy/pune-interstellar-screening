      ...
      <footer>
        <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8 w-full">
          ...
          <ul>
            ...
            <li className="text-base text-gray-500">
              Organizers are not responsible for any kind of loss arising from
              the event. Participate at your own risk.
            </li>
            <li className="text-base text-gray-500">
            ...
            <li className="text-base text-gray-500">
              By participating in the event, you agree to abide by the above
              rules and take full responsibility for your actions.
            </li>
          </ul>
        </div>
      </footer>
